...
SELECTION = [
    ...
    ("Castelmola_yoav-aziz-to8ugTFsONc-unsplash.jpg",          "v-castelmola-tetti"),
    ...
    ("Catania_maria-bobrova-7xy3l9RV4Qw-unsplash.jpg",         "v-catania-liotru"),
    ("Catania_carla-lipani-f2PyFPC34Z8-unsplash.jpg",          "v-catania-crociferi"),
    ("Catania_mateusz-butkiewicz-5R5zxf23u5k-unsplash.jpg",    "v-catania-mercato"),
